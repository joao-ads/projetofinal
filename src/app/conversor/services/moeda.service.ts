...
export class MoedaService {
  ...
  private moedasObj = [ //http://fixer.io
    ...
    listarTodas(): Moeda[]{
      ...
      for (let moedasObj of this.moedasObj){ //para percorrer o array
        let moeda : Moeda = new Moeda(); //para fazer a varredura foi criada uma variavel moeda 
        //e usou como objeto auxiliar para usar no objeto
        Object.assign(moeda, moedasObj); //Object.assign é o que 
